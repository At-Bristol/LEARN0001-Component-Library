...
const Input = ({ type = 'text', title, placeholder, isValid = null, validate, value, errorMessage }) => {
    let output = ''
...
<TitleBreak title={title} isValid={isValid}/>

    {
        <DefaultInput  label='Name' placeholder={placeholder} />
    }
